...
// Vercel serverless functions are stateless between calls, so we use
// a global object that persists within the same function instance.
// For a demo this works great — data lives as long as the session is warm.

const store = global._elementumStore || (global._elementumStore = {

  purchaseRequests: [
    {
      pr_id: "PR-1096", description: "AWS Credits Q1",
      vendor_id: "amazon", vendor_name: "Amazon Web Services",
      amount: 8000.00, budget_category: "Software & Services",
      requestor: "J. Davis", status: "AUTO_APPROVED",
      po_number: "PO-2024-0891", source: "MANUAL",
      ai_policy: { auto_approved: true, routing: "AUTO_APPROVED" },
      created_at: "2024-11-12T09:14:00",
    },
    {
      pr_id: "PR-1095", description: "Lab Supplies — Q4",
      vendor_id: "thermo", vendor_name: "Thermo Fisher Scientific",
      amount: 3200.00, budget_category: "R&D Supplies",
      requestor: "M. Chen", status: "PENDING_APPROVAL",
      source: "MANUAL",
      ai_policy: { auto_approved: false, routing: "PENDING_HUMAN_APPROVAL" },
      created_at: "2024-11-11T14:22:00",
    },
    {
      pr_id: "PR-1094", description: "IT Equipment Refresh",
      vendor_id: "dell", vendor_name: "Dell Technologies",
      amount: 12400.00, budget_category: "IT Infrastructure",
      requestor: "T. Rodriguez", status: "PENDING_APPROVAL",
      source: "MANUAL",
      ai_policy: { auto_approved: false, routing: "PENDING_HUMAN_APPROVAL" },
      created_at: "2024-11-12T08:30:00",
    },
    {
      pr_id: "PR-1093", description: "Office Supplies Nov",
      vendor_id: "staples", vendor_name: "Staples Business",
      amount: 892.50, budget_category: "Office Supplies",
      requestor: "A. Patel", status: "AUTO_APPROVED",
      po_number: "PO-2024-0890", source: "MANUAL",
      ai_policy: { auto_approved: true, routing: "AUTO_APPROVED" },
      created_at: "2024-11-11T11:03:00",
    },
    {
      pr_id: "PR-1092", description: "MRO Supplies",
      vendor_id: "grainger", vendor_name: "Grainger",
      amount: 1440.00, budget_category: "MRO",
      requestor: "K. Williams", status: "AUTO_APPROVED",
      po_number: "PO-2024-0889", source: "MANUAL",
      ai_policy: { auto_approved: true, routing: "AUTO_APPROVED" },
...
function aiPolicyCheck(amount, vendorId) {
  ...
  return {
    ...
    ai_recommendation:  autoApprove
      ? "Approve — vendor pre-approved, within threshold."
      : "Route to manager — exceeds $5k threshold.",
  };
}

function generatePO(pr) {
  const po = {
    po_number:    genId("PO"),
    pr_id:        pr.pr_id,
...
module.exports = { store, genId, aiPolicyCheck, generatePO, cors };
